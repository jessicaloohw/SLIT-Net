...
def main():
    ...
    for MODEL_NUM in range(MODEL_NUM_START, MODEL_NUM_END+1):
        ...
        for image_id in test_dataset.image_ids:
            ...
            results_small = restrict_within_limbus(results_small, IDS_TO_RESTRICT=[1,2,4,6], LIMBUS_ID=7, HIGH_OVERLAP=0.7)
            results_small = restrict_within_limbus(results_small, IDS_TO_RESTRICT=[3], LIMBUS_ID=7, HIGH_OVERLAP=0.5)
